...
import { LinkedinMini, XMini, MailMini, GitHubMini, VercelMini } from './Icons'
...
/>
          ...
          <div className="social-links">
            ...
            <a href="https://github.com/kuhamba-tech/optimumscs" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social-icon-github"><GitHubMini /></a>
            <a href="https://optimumscs.vercel.app" target="_blank" rel="noopener noreferrer" aria-label="Vercel" className="social-icon-vercel"><VercelMini /></a>
          </div>
        </div>
